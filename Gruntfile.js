// Generated on 2015-04-13 using generator-angular 0.8.0
'use strict';
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      styles: {
        ...
        dest: '.tmp/styles/',
        // src: '{,*/}*.css'
        src: '**/*.css' //edited by Derrick Roccka
      }
    },
    ...
    html_snapshots: {
      ...
      options: {
        input: 'array',
        source: ['http://localhost:9001/#/home', 'http://localhost:9001/#/test'],
        // selector: { '__default': '' },
        outputDirClean: 'true',
        outputDir: './snapshots',
        port: 9001
